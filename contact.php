...
<html>
      ...
      <div id="contact">
        ...
        <div id="contact-text">
          <p>
            ...
            <b>CPR!</b> Heb je zin in een pannenkoek met je vrienden? Heb je iets te vieren? Ben je binnenkort jarig? Wij zorgen voor overheerlijke pannenkoeken en desserts!  <br> <br>
            <span>
              <b>Reserveer</b> 
              nu een tafel, of stuur gewoon een berichtje naar ons toe:
            </span>
          </p>
        </div>
        <div id="contact-input">
          <form class="w3-container w3-card-4 w3-light-grey">
            ...
            <p>      
              <input class="w3-input w3-border-0" type="date">
            </p>
            <p>      
  ...
  <script>
    function myMap() {
      var mapProp= {
        center:new google.maps.LatLng(51.1748764,4.3468642),zoom:18,
      };
